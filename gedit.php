...
<html>
<head>
<link rel="shortcut icon" href="gedit.png?rev=<?=time();?>" type="image/x-icon">
...
<img class='hover' title="Open" width=9% src="directory.png?rev=<?=time();?>" id="filesButton" onclick="var fn = filename.value; window.location.href='gedit.php?name='+fn;">
...
<img class='hover' title="Return to Main Menu" width=9% src="menu.png?rev=<?=time();?>" id="menuButton" onclick="window.location.href='menu.php';">
<br>
